namespace SWA
{
    partial class GeneralDocumentPrintForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "GeneralDocumentPrintForm";
            this.Text = "Печать документа";
            this.Load += new System.EventHandler(this.GeneralDocumentPrintForm_Load);
